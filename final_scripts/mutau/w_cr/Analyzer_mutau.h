...
#ifndef Analyzer_mutau_h
#define Analyzer_mutau_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   Analyzer_mutau(TTree *tree=0);
   Analyzer_mutau(const char* file1, const char* file2);
   virtual ~Analyzer_mutau();
   ...
   virtual vector<int> getRelaxedMuCand(double pt, double eta);
...
#ifdef Analyzer_mutau_cxx
Analyzer_mutau::Analyzer_mutau(const char* file1, const char* file2)
{
...
Int_t Analyzer_mutau::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Analyzer_mutau::LoadTree(Long64_t entry)
{
...
void Analyzer_mutau::Init(TChain *tree)
{
...
void Analyzer_mutau::Show(Long64_t entry)
{
...
Int_t Analyzer_mutau::Cut(Long64_t entry)
{
...
#endif // #ifdef Analyzer_mutau_cxx
