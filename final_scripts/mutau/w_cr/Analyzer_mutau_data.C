...
std::vector<int> Analyzer_mutau_data::getMuCand(double muPtCut, double muEtaCut){
...
std::vector<int> Analyzer_mutau_data::getRelaxedMuCand(double muPtCut, double muEtaCut){
  std::vector<int> tmpCand;
  tmpCand.clear();
  //Loop over muons                                                           
  for(int iMu=0;iMu<nMu;iMu++)
...
std::vector<int> Analyzer_mutau_data::getRelaxedTauCand(double tauPtCut, double tauEtaCut){
  std::vector<int> tmpCand;
  tmpCand.clear();
  //Loop over taus                                                                   
  for(int iTau=0;iTau<nTau;iTau++)
...
bool Analyzer_mutau_data::thirdLeptonVeto(){
...
double Analyzer_mutau_data::dR(int mu_index, int tau_index)
{
