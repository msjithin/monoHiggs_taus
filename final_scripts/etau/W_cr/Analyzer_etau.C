...
void Analyzer_etau::Loop(Long64_t maxEvents, int reportEvery, string SampleName)
{
   ...
   TH1F* h_Cutflow= new TH1F("Cutflow","Events at each level of selection",7,0,14);
   TH1F* h_Cutflow_qcd= new TH1F("Cutflow_qcd","Events at each level of selection",7,0,14);
   ...
   Long64_t nentriesToCheck = nentries;
	...
	for (Long64_t jentry=0; jentry<nentriesToCheck;jentry++)
	{
	  ...
	  //double scaleFactor_1=sf_tauID*sf_Zvtx;
	  ...
	  if(sample== "WJetsToLNu" || sample== "WJetsToLNu_ext")
	    {
	  ...
	  if(metFilters==0) 
	      ...
	      if(HLTEleMuX>>3&1 == 1) // Single electron trigger
		{
		  ...
		  if (sample=="WJetsToLNu_inc" || sample=="WJetsToLNu"|| sample=="WJetsToLNu_HT-100To200" || sample=="WJetsToLNu_HT-1200To2500" || sample==" WJetsToLNu_HT-200To400"  || sample=="WJetsToLNu_HT-2500ToInf" || sample==" WJetsToLNu_HT-400To600" || sample=="WJetsToLNu_HT-600To800" || sample=="WJetsToLNu_HT-800To1200" || sample=="WJetsToLNu_inc_ext" || sample=="W1JetsToLNu_ext" || sample=="W2JetsToLNu" || sample=="W3JetsToLNu" || sample=="W4JetsToLNu" )
		    {
			  ...
			  if( (eleCharge->at(eleCand[0]))*(tauCharge->at(tauCand[0])) < 0 ) // opposite charge condition
			      ...
			      if(deltaR > 0.3 )
				{
				  ...
				  if( thirdLeptonVeto()==true )
				  {
					...
					float eMet_trMass = TMass_F((elePt->at(eleCand[0])),(elePhi->at(eleCand[0])),pfMET,pfMETPhi  );
					if( (eMet_trMass>80) )
					  {
	  ...
	  h_Cutflow->SetBinContent(7, nMtPassed);
	  ...
	  h_Events_level_qcd->SetBinContent(9, nPassedBjetVeto_qcd);
          h_Events_level_qcd->SetBinContent(10, nMtPassed_qcd);
	  h_Events_level_qcd->SetBinContent(11, nPassedHiggsPtcut_qcd); 
	  h_Events_level_qcd->SetBinContent(12, nPassedVisibleMasscut_qcd); 
	  h_Events_level_qcd->SetBinContent(13, nPassedMETcut_qcd); 
	  //          h_Events_level->SetBinContent(13, nFinal_afterSelections);
          ...
          h_Cutflow_qcd->SetBinContent(7, nMtPassed_qcd);
  ...
  for(int iTau=0;iTau<nTau;iTau++)
    {
      ...
      if( (taubyTightIsolationMVArun2017v2DBoldDMwLT2017->at(iTau)!=1 && taubyLooseIsolationMVArun2017v2DBoldDMwLT2017->at(iTau)==1)) tauIsolation = true;
  ...
  for(int iTau=0;iTau<nTau;iTau++)
    {
      ...
      if( tauByMVA6TightElectronRejection->at(iTau) == 1 && tauByLooseMuonRejection3->at(iTau) == 1) tauId = true;
      if( (taubyTightIsolationMVArun2017v2DBoldDMwLT2017->at(iTau)!=1 && taubyLooseIsolationMVArun2017v2DBoldDMwLT2017->at(iTau)==1)) tauIsolation = true;
      if( tauDecayMode->at(iTau)==1>0 ) decayModeCut = true;
