...
#ifndef Analyzer_tautau_data_h
#define Analyzer_tautau_data_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Analyzer_tautau_data(const char* file1, const char* file2);
   virtual ~Analyzer_tautau_data();
...
#ifdef Analyzer_tautau_data_cxx
Analyzer_tautau_data::Analyzer_tautau_data(const char* file1, const char* file2){
   ...
   std::cout<<"All files added...  >> Data"<<endl;
   std::cout<<"Initizlizing chain."<<endl;
   Init(chain);
   BookHistos(file2);
}

Analyzer_tautau_data::~Analyzer_tautau_data()
{
   if (!fChain) return;
...
Int_t Analyzer_tautau_data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Analyzer_tautau_data::LoadTree(Long64_t entry)
{
...
void Analyzer_tautau_data::Init(TTree *tree)
{
...
Bool_t Analyzer_tautau_data::Notify()
{
...
void Analyzer_tautau_data::Show(Long64_t entry)
{
...
Int_t Analyzer_tautau_data::Cut(Long64_t entry)
{
...
#endif // #ifdef Analyzer_tautau_data_cxx
