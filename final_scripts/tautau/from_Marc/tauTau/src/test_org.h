...
// Mon May 27 03:55:34 2019 by ROOT version 6.10/09
// from TTree EventTree/Event data (tag V09_04_09_00)
// found on file: /hdfs/store/user/gomber/MonoHiggs_Tau_2017_dataset_correctditautrigger/Tau/crab_Tau_dataset1/181028_213808/0000/ggtree_data_10.root
//////////////////////////////////////////////////////////
...
#ifdef test_org_cxx
test_org::test_org(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/gomber/MonoHiggs_Tau_2017_dataset_correctditautrigger/Tau/crab_Tau_dataset1/181028_213808/0000/ggtree_data_10.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hdfs/store/user/gomber/MonoHiggs_Tau_2017_dataset_correctditautrigger/Tau/crab_Tau_dataset1/181028_213808/0000/ggtree_data_10.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/hdfs/store/user/gomber/MonoHiggs_Tau_2017_dataset_correctditautrigger/Tau/crab_Tau_dataset1/181028_213808/0000/ggtree_data_10.root:/ggNtuplizer");
...
Int_t test_org::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t test_org::LoadTree(Long64_t entry)
{
...
void test_org::Show(Long64_t entry)
{
...
Int_t test_org::Cut(Long64_t entry)
{
