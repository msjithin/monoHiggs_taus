...
// Mon May 27 03:56:06 2019 by ROOT version 6.10/09
// from TTree EventTree/Event data (tag V09_04_09_00)
// found on file: /hdfs/store/user/gomber/MonoHiggs_2017_12April_AllMC_withtrigger/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/crab_DYJetsToLL_LO/181109_181451/0000/ggtree_mc_10.root
//////////////////////////////////////////////////////////

#ifndef test_org_mc_h
#define test_org_mc_h
...
#ifdef test_org_mc_cxx
test_org_mc::test_org_mc(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/gomber/MonoHiggs_2017_12April_AllMC_withtrigger/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/crab_DYJetsToLL_LO/181109_181451/0000/ggtree_mc_10.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hdfs/store/user/gomber/MonoHiggs_2017_12April_AllMC_withtrigger/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/crab_DYJetsToLL_LO/181109_181451/0000/ggtree_mc_10.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/hdfs/store/user/gomber/MonoHiggs_2017_12April_AllMC_withtrigger/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/crab_DYJetsToLL_LO/181109_181451/0000/ggtree_mc_10.root:/ggNtuplizer");
...
test_org_mc::~test_org_mc()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t test_org_mc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t test_org_mc::LoadTree(Long64_t entry)
{
...
void test_org_mc::Init(TTree *tree)
{
...
void test_org_mc::Show(Long64_t entry)
{
...
Int_t test_org_mc::Cut(Long64_t entry)
{
