...
rm -f $exefilename
g++ $1 -o $exefilename `root-config --cflags --glibs` -lRooFit -lRooFitCore /nfs_scratch/tost/CMSSW_9_4_9/lib/slc7_amd64_gcc630/libHTTutilitiesJet2TauFakes.so # /nfs_scratch/tost/CMSSW_9_4_9/lib/slc7_amd64_gcc630/libTauAnalysisToolsTauTriggerSFs.so
echo ""
