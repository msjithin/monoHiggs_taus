...
def add_lumi():
    ...
    lumi.SetTextFont (   42 )
    lumi.AddText("e#tau_{h} Wcr 2017, 41.521 fb^{-1} (13 TeV)")
    return lumi
...
print (dirName[0]+"ZTTinc_"+histoname)
...
#    W1Jets=OutFile.Get(dirName[0]+"W1JetsToLNu_"+histoname)
#    W2Jets=OutFile.Get(dirName[0]+"W2JetsToLNu_"+histoname)
#    W3Jets=OutFile.Get(dirName[0]+"W3JetsToLNu_"+histoname)
#    W4Jets=OutFile.Get(dirName[0]+"W4JetsToLNu_"+histoname)
#    WJets.Add(W1Jets)
#    WJets.Add(W2Jets)
#    WJets.Add(W3Jets)
#    WJets.Add(W4Jets)
 ...
 #   ggWW=OutFile.Get(dirName[0]+"GluGluWWTo2L2Nu_"+histoname)
  ...
  #  ZH125_mc.SetLineWidth(5)
    ...
    if histoname=='Events_level_':
      ...
      text_file.write("\n")
      text_file.write("*************  sample "+histoname )
      ...
      text_file.write("\n")
      text_file.write(" Total bkg (not inc Wjets) = "+str( ZTT.GetBinContent(9)+TTJ.GetBinContent(9)+VV.GetBinContent(9)+ggH125.GetBinContent(9)+ZJetsToNuNu.GetBinContent(9) ))
      text_file.write("\n")
      ...
      text_file.write("\n")
      text_file.write("WJets events = "+str(WJets.GetBinContent(10) ))
      text_file.write("\n")
      ...
      text_file.write("\n")
      text_file.write(" Total bkg (not inc Wjets) = "+str( ZTT.GetBinContent(10)+TTJ.GetBinContent(10)+VV.GetBinContent(10)+ggH125.GetBinContent(10)+ZJetsToNuNu.GetBinContent(10) ))
      text_file.write("\n")
      ...
      text_file.write("\n")
      text_file.write(" Total bkg (not inc Wjets) = "+str( ZTT.GetBinContent(11)+TTJ.GetBinContent(11)+VV.GetBinContent(11)+ggH125.GetBinContent(11)+ZJetsToNuNu.GetBinContent(11) ))
      text_file.write("\n")
      ...
      text_file.write("\n")
      text_file.write("\n")
      text_file.write(" Total bkg (not inc Wjets) = "+str( ZTT.GetBinContent(12)+TTJ.GetBinContent(12)+VV.GetBinContent(12)+ggH125.GetBinContent(12)+ZJetsToNuNu.GetBinContent(12) ))
      text_file.write("\n")
...
if piAxis == 1:
  ...
  h1.GetXaxis().SetBinLabel(10,"tr mass cut");
