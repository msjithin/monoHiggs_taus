...
void make_hist(string input_file, string output_file, string histname_string, string sample_name, string name_ ,  Double_t weight_lumi , bool isNLO, double ngen_, double xsec)
{
  ...
  */
  ...
  if(histname == "Events_level_"){
  ...
  else if(histname == "Events_level_qcd_"){
    TH1F* histo_events_level = (TH1F*)((TH1F*)file_input->Get("Events_level_qcd"))->Clone(TString(name+"_"+histname));
    // cout<<"3. updating file for "<< histname<<endl;
    if(sample=="data_obs"){
      histo_events_level->SetBinContent(10,0.0);
      histo_events_level->SetBinContent(11,0.0);
  ...
  else if(histname == "Cutflow_qcd_"){
    TH1F* histo_events_level = (TH1F*)((TH1F*)file_input->Get("Cutflow_qcd"))->Clone(TString(name+"_"+histname));
    // cout<<"3. updating file for "<< histname<<endl;
    histo_events_level->Scale(net_weight);
    histo_events_level->Write();
  }
    ...
    //cout<<"************************ works till here, hist 1" << histname <<" *********************"<<endl;
    ...
    //cout<<"************************ works till here, after hist 2 *********************"<<endl;
    ...
    //cout<<"************************ works till here, after hist 3 *********************"<<endl;
    ...
    //cout<<"************************ works till here, after hist 4 *********************"<<endl;
    ...
    histo_etau_5->Write();
    histo_etau_6->Write();
    //cout<<"************************ works till here, after hist 5 *********************"<<endl;
...
//  plotnames.push_back(TString(""));
  ...
  histnames.push_back("TotalTrMass_");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("tot T_Mass [GeV]"));
  plotnames.push_back(TString("tot_T_Mass"));
  ...
  histnames.push_back("Events_level_qcd_");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Events_level_qcd_"));
  plotnames.push_back(TString("Evenets_level_qcd_"));
  ...
  histnames.push_back("Cutflow_qcd_");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Cutflow_qcd_"));
  plotnames.push_back(TString("Cutflow_qcd_"));
...
*/
  ...
  */
  ...
  TDirectory *TotalTrMass = f_output->mkdir("TotalTrMass_");
  ...
  TDirectory *Events_level_qcd_all = f_output->mkdir("Events_level_qcd_");
  TDirectory *Cutflow_qcd_all = f_output->mkdir("Cutflow_qcd_");
  ...
  make_hist(input, output, "TotalTrMass_", sample ,name,weight, true, ngen , xs);
  ...
  make_hist(input, output, "Events_level_qcd_", sample ,name,weight, true, ngen , xs);
  make_hist(input, output, "Cutflow_qcd_", sample ,name,weight, true, ngen , xs);
