...
if (firstarg == "h_dPhi_" or firstarg =="Tau_phi_" or firstarg =="Electron_phi_" or firstarg =="dphi_eleMet_" or firstarg =="dphi_tauMet"):
  piAxis = 1
else :
  piAxis = 0
...
def add_lumi():
    ...
    lumi.SetTextFont (   42 )
    lumi.AddText("e#tau_{h}   2017, 41.521 fb^{-1} (13 TeV)")
    return lumi
...
for i in range (0,ncat):
    HistoData=OutFile.Get(dirName[0]+"data_obs_"+histoname_qcd)
    
    #    ZTT=OutFile.Get(dirName[0]+"DY_LO_"+histoname_qcd)
    VV=OutFile.Get(dirName[0]+"VV_"+histoname_qcd)

    ZTT=OutFile.Get(dirName[0]+"ZTTinc_"+histoname_qcd)
    ZTT1=OutFile.Get(dirName[0]+"ZTT1jet_"+histoname_qcd)
    ZTT2=OutFile.Get(dirName[0]+"ZTT2jet_"+histoname_qcd)
    ZTT3=OutFile.Get(dirName[0]+"ZTT3jet_"+histoname_qcd)
    ZTT4=OutFile.Get(dirName[0]+"ZTT4jet_"+histoname_qcd)
    ZTT.Add(ZTT1)
    ZTT.Add(ZTT2)
    ZTT.Add(ZTT3)
    ZTT.Add(ZTT4)

    EWKZ_0=OutFile.Get(dirName[0]+"EWKZ2Jets_ZToLL_"+histoname_qcd)
    EWKZ=OutFile.Get(dirName[0]+"EWKZ2Jets_ZToNuNu_"+histoname_qcd)
    EWKZ.Add(EWKZ_0)
    EWKW_0=OutFile.Get(dirName[0]+"EWKWMinus2Jets_"+histoname_qcd)
    EWKW=OutFile.Get(dirName[0]+"EWKWPlus2Jets_"+histoname_qcd)
    EWKW.Add(EWKW_0)

    ZTT.Add(EWKZ)

    #TTJ=OutFile.Get(dirName[0]+"TTJets_"+histoname_qcd)
    TTJ=OutFile.Get(dirName[0]+"TTTo2L2Nu_"+histoname_qcd)
    TTJ_1=OutFile.Get(dirName[0]+"TTToHadronic_"+histoname_qcd)
    TTJ_2=OutFile.Get(dirName[0]+"TTToSemiLeptonic_"+histoname_qcd)
    TTJ.Add(TTJ_1)
    TTJ.Add(TTJ_2)

    ggH125=OutFile.Get(dirName[0]+"GluGluHToTauTau_"+histoname_qcd)
    qqH125=OutFile.Get(dirName[0]+"VBFHToTauTau_"+histoname_qcd)
    qqH125_1=OutFile.Get(dirName[0]+"VBFHToWWTo2L2Nu_"+histoname_qcd)
    ZHToTauTau=OutFile.Get(dirName[0]+"ZHToTauTau_"+histoname_qcd)
    WpH125=OutFile.Get(dirName[0]+"WPlusHToTauTau_"+histoname_qcd)
    WmH125=OutFile.Get(dirName[0]+"WMinusHToTauTau_"+histoname_qcd)
    ...
    sT_t_antitop=OutFile.Get(dirName[0]+"ST_t-channel_antitop_"+histoname_qcd)
    sT_t_top=OutFile.Get(dirName[0]+"ST_t-channel_top_"+histoname_qcd)
    sT_tW_antitop=OutFile.Get(dirName[0]+"ST_tW_antitop_"+histoname_qcd)
    sT_tW_top=OutFile.Get(dirName[0]+"ST_tW_top_"+histoname_qcd)
    ...
    WJets=OutFile.Get(dirName[0]+"WJetsToLNu_"+histoname_qcd)
    WJets_100To200=OutFile.Get(dirName[0]+"WJetsToLNu_HT100To200_"+histoname_qcd)
    WJets_200To400=OutFile.Get(dirName[0]+"WJetsToLNu_HT200To400_"+histoname_qcd)
    WJets_400To600=OutFile.Get(dirName[0]+"WJetsToLNu_HT400To600_"+histoname_qcd)
    WJets_600To800=OutFile.Get(dirName[0]+"WJetsToLNu_HT600To800_"+histoname_qcd)
    WJets_800To1200=OutFile.Get(dirName[0]+"WJetsToLNu_HT800To1200_"+histoname_qcd)
    WJets_1200To2500=OutFile.Get(dirName[0]+"WJetsToLNu_HT1200To2500_"+histoname_qcd)
    WJets_2500ToInf=OutFile.Get(dirName[0]+"WJetsToLNu_HT2500ToInf_"+histoname_qcd)
    ...
    VVV=OutFile.Get(dirName[0]+"VVV_"+histoname_qcd)
    ZJetsToNuNu=OutFile.Get(dirName[0]+"ZJetsToNuNu_"+histoname_qcd)
    WWJJ=OutFile.Get(dirName[0]+"WpWpJJ_EWK_QCD_"+histoname_qcd)
 #   ggWW=OutFile.Get(dirName[0]+"GluGluWWTo2L2Nu_"+histoname_qcd)
    VV.Add(WWJJ)
    VV.Add(VVV)
    VV.Add(sT_t_antitop)
  #  VV.Add(ggWW)
...
#      text_file.close()
    ...
    if histoname_qcd=='Electron_Pt_13' or histoname_qcd=='h_dPhi_13' or histoname_qcd=='Electron_phi_13'or histoname_qcd=='Tau_phi_13' or histoname_qcd=='Electron_eta_13'or histoname_qcd=='Tau_eta_13':
    ...
    if histoname_qcd=='Electron_Pt_16' or histoname_qcd=='h_dPhi_16' or histoname_qcd=='Electron_phi_16'or histoname_qcd=='Tau_phi_16' or histoname_qcd=='Electron_eta_16'or histoname_qcd=='Tau_eta_16':
    ...
    elif histoname_qcd=='Events_level_':
    ...
    errorBand=ZTT.Clone()
#    errorBand=OutFile.Get(dirName[0]+"DY_LO_"+histoname_qcd).Clone()
#    errorBand.Add(ZTT1)
#    errorBand.Add(ZTT2)
#    errorBand.Add(ZTT3)
#    errorBand.Add(ZTT4)
...
elif histoname_qcd=='Events_level_qcd_':
...
elif histoname_qcd=='Cutflow_qcd_':
