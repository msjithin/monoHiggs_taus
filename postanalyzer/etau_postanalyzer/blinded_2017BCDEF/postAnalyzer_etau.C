...
using namespace std;
Double_t Luminosity = 10380.25;//Lumi for inclusive
...
void make_hist(string input_file, string output_file, string histname_string, string sample_name, string name_ ,  Double_t weight_lumi , bool isNLO, double ngen_, double xsec)
{
  ...
  if(histname == "Events_level_"){
    ...
    if(sample=="data_obs"){ net_weight = 1.0;  }
    if(sample=="data_obs" && histname =="pfMET_"){ net_weight = 1.0;  }
...
int main(int argc, char** argv)
{
  ...
  cout<<"XXXXXXXXXXXXXXXXX   This works P2  "<<endl;
  float tes=0;
  if (argc > 1) {
    tes = atof(argv[5]);
  }
  ...
  else if (sample=="ZTTinc"){ xs=LOtoNNLO_DY*4954.0; weight=4.877/4;}
  else if (sample=="ZTT1jet"){ xs=LOtoNNLO_DY*1012.5; weight=1.09/4;}
  else if (sample=="ZTT2jet"){ xs=LOtoNNLO_DY*332.8; weight=1.23/4;}
  else if (sample=="ZTT3jet"){ xs=LOtoNNLO_DY*101.8; weight=2.28/4;}
  else if (sample=="ZTT4jet"){ xs=LOtoNNLO_DY*54.8; weight=0.54/4;}
  
  else if (sample=="WJetsToLNu_inc") {xs=61526.7; weight=57.29/4;}
  else if (sample=="W1JetsToLNu") {xs=11778.3638; weight=7.81/4;}
  else if (sample=="W2JetsToLNu") {xs=3849.21974; weight=17.047/4;}
  else if (sample=="W3JetsToLNu") {xs=1166.04787; weight=2.36/4;}
  else if (sample=="W4JetsToLNu") {xs=593.055246; weight=2.098/4;}
