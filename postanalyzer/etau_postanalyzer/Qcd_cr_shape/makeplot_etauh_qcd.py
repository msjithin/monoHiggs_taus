...
#    ZTT.Add(ZTT4)
 ...
 #   ggWW=OutFile.Get(dirName[0]+"GluGluWWTo2L2Nu_"+histoname)
  ...
  #  VV.Add(ggWW)
    ...
    ZTT_qcd=OutFile.Get(dirName[0]+"DY_LO_"+histoname_qcd)
    VV_qcd=OutFile.Get(dirName[0]+"VV_"+histoname_qcd)
    ZTT1_qcd=OutFile.Get(dirName[0]+"ZTT1_"+histoname_qcd)
    ZTT2_qcd=OutFile.Get(dirName[0]+"ZTT2_"+histoname_qcd)
    ZTT3_qcd=OutFile.Get(dirName[0]+"ZTT3_"+histoname_qcd)
    ZTT4_qcd=OutFile.Get(dirName[0]+"ZTT4_"+histoname_qcd)
    ...
    TTJ_qcd=OutFile.Get(dirName[0]+"TTTo2L2Nu_"+histoname_qcd)
    TTJ_qcd_1=OutFile.Get(dirName[0]+"TTToHadronic_"+histoname_qcd)
    TTJ_qcd_2=OutFile.Get(dirName[0]+"TTToSemiLeptonic_"+histoname_qcd)
    TTJ_qcd.Add(TTJ_qcd_1)
    TTJ_qcd.Add(TTJ_qcd_2) 
 ...
 #   WWW.SetLineColor(1)
  ...
  #  stack.Add(WWW)
    ...
    if histoname=='Events_level_':
      ...
      text_file.write("\n")
      text_file.write("WJets events = "+str(WJets.GetBinContent(12) ))
      text_file.write("\n")
      ...
      text_file.write("\n")
      text_file.write("\n")
      text_file.write(" Total bkg = "+str( ZTT.GetBinContent(12)+TTJ.GetBinContent(12)+WJets.GetBinContent(12)+VV.GetBinContent(12)+ggH125.GetBinContent(12)+ZJetsToNuNu.GetBinContent(12) ))
      text_file.write("\n")
