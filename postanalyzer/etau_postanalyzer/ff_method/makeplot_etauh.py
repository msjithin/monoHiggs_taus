...
OutFile=ROOT.TFile("f_etau_fakebkg.root","r")
...
#    stack.Add(TTJ)
  #  stack.Add(F_bkg)
    ...
    if histoname=='ffEvents':
      print "before "
      print "DY events = ", ZTT.GetBinContent(1)
      print "TT events = ", TTJ.GetBinContent(1)      
      print "VV events = ", VV.GetBinContent(1)
      print "ggH125 events = ", ggH125.GetBinContent(1)
      print "ZJetsToNuNu events = ", ZJetsToNuNu.GetBinContent(1)

      print "Data events = ",HistoData.GetBinContent(1)
      
      print "After "
      print "DY events = ", ZTT.GetBinContent(5)
      print "TT events = ", TTJ.GetBinContent(5)
      print "VV events = ", VV.GetBinContent(5)
      print "ggH125 events = ", ggH125.GetBinContent(5)
      print "ZJetsToNuNu events = ", ZJetsToNuNu.GetBinContent(5)

      print "Data events = ",HistoData.GetBinContent(5)
