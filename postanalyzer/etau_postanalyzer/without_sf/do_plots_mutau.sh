...
#    python makeplot_mutauh.py Tau_Pt_ $histNumber pT tau -logYaxis logy
    python makeplot_mutauh.py Tau_Pt_ $histNumber pT tau -logYaxis logy
    python makeplot_mutauh.py Muon_Pt_ $histNumber pT ele -logYaxis logy
...
#python makeplot_mutauh.py mttot_1 total 'transverse mass' -logYaxis logy
    python makeplot_mutauh.py Mt_ $histNumber 'ele-met' ' transverse mass' -logYaxis logy 
...
#python makeplot_mutauh.py iso_1 ele iso -logYaxis logy
    ...
    python makeplot_mutauh.py Muon_eta_ $histNumber ele '#eta' -logYaxis logy
    python makeplot_mutauh.py Tau_phi_ $histNumber tau '#phi' -logYaxis logy
    python makeplot_mutauh.py Muon_phi_ $histNumber ele '#phi' -logYaxis logy
