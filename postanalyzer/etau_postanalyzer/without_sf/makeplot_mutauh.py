...
#    WWW.SetFillColor(ROOT.TColor.GetColor("#99ccff"))
 ...
 #   stack.Add(ZTT)
    ...
    if histoname=='Events_level_':
      ...
      text_file = open("Output_mutau.txt", "a+")
      text_file.write("\n")
...
#      text_file.close()
    ...
    if histoname=='Muon_Pt_3' or histoname=='h_dPhi_3' or histoname=='Muon_phi_3'or histoname=='Tau_phi_3' or histoname=='Muon_eta_3'or histoname=='Tau_eta_3':
...
c.SaveAs("plots_mutau/"+firstarg+secondarg+".png")
