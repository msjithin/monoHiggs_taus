...
int main(int argc, char** argv)
{
  ...
  */
  ...
  cout<<" Input file : " << std::left << std::setw(110) << input.c_str() << std::setw(25) << " Output written to : "<< output.c_str() <<endl;
  ...
  else if (sample=="ZTTinc"){ xs=LOtoNNLO_DY*5765.4; weight=0.61412788;}
  else if (sample=="ZTT1jet"){ xs=LOtoNNLO_DY*1012.5; weight=0.223293643;}
  else if (sample=="ZTT2jet"){ xs=LOtoNNLO_DY*332.8; weight=0.247448581;}
  else if (sample=="ZTT3jet"){ xs=LOtoNNLO_DY*101.8; weight=0.390113175;}
  else if (sample=="ZTT4jet"){ xs=LOtoNNLO_DY*54.8; weight=0.121961121;}
...
//  plotnames.push_back(TString(""));
  ...
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("ele-MET M_{T} [GeV]"));
  ...
  plotnames.push_back(TString("total_mT"));
