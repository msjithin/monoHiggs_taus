...
def add_lumi():
    ...
    lumi.SetTextFont (   42 )
    lumi.AddText("e#tau_{h}   2017, 10.38 fb^{-1} (13 TeV)")
    return lumi
...
OutFile_fbkg=ROOT.TFile("ff_method/f_etau_fakebkg.root","r")
...
#      text_file.close()
    ...
    if histoname=='Electron_Pt_7' or histoname=='Electron_Pt_8' or histoname=='Electron_Pt_9':
      ...
      text_file.write("\n")
      text_file.write("ggH events = "+str(ggH125.Integral(0,nbins_ggH125+1) ))
      text_file.write("\n")
      text_file.write("ZJets events = "+str(ZJetsToNuNu.Integral(0,nbins_ZJetsToNuNu+1) ))
      text_file.write("\n")
      tot_bkg_sum = ZTT.Integral(0,nbins_ZTT+1) + VV.Integral(0,nbins_VV+1) + TTJ.Integral(0,nbins_TT+1)+F_bkg.Integral(0,nbins_F_bkg+1)+ ggH125.Integral(0,nbins_ggH125+1)+ ZJetsToNuNu.Integral(0,nbins_ZJetsToNuNu+1)
      text_file.write("total bkg  =  "+ str( tot_bkg_sum ))
      text_file.write("\n")
...
if piAxis == 1:
  ...
  h1.GetXaxis().SetBinLabel(13,"VisibleMass");
  ...
  h1.GetXaxis().SetBinLabel(4,"Good ele");
  ...
  h1.GetXaxis().SetBinLabel(1,"Good ele");
  h1.GetXaxis().SetNdivisions(-115)
  h1.GetXaxis().LabelsOption("v")
  h1.GetXaxis().SetTitle(" cut flow")
  h1.SetMaximum(1.2)#FIXME(1.2)
