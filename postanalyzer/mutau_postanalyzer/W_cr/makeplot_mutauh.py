...
if firstarg != 'Events_level_' :
  ...
  histoname_qcd =  firstarg+'1'+secondarg
else :
  histoname = firstarg
  histoname_qcd =  firstarg+'qcd_'
print "Item / histogram name = ", histoname
print "Item / histogram name for qcd = ", histoname_qcd
def getopts(argv):
 ...
 #   ggWW=OutFile.Get(dirName[0]+"GluGluWWTo2L2Nu_"+histoname)
  ...
  #  VV.Add(ggWW)
    ...
    if firstarg != 'Events_level_' :
      ...
      dirName[1]='Events_level_qcd_/'
      
    print (dirName[0]+"data_obs_"+histoname_qcd)
    QCD=OutFile.Get(dirName[0]+"data_obs_"+histoname_qcd)
    print (dirName[0]+"ZTT_"+histoname_qcd)

    ZTT_qcd=OutFile.Get(dirName[0]+"ZTTinc_"+histoname_qcd)
    VV_qcd=OutFile.Get(dirName[0]+"VV_"+histoname_qcd)
    ZTT1_qcd=OutFile.Get(dirName[0]+"ZTT1jet_"+histoname_qcd)
    ZTT2_qcd=OutFile.Get(dirName[0]+"ZTT2jet_"+histoname_qcd)
    ZTT3_qcd=OutFile.Get(dirName[0]+"ZTT3jet_"+histoname_qcd)
    ZTT4_qcd=OutFile.Get(dirName[0]+"ZTT4jet_"+histoname_qcd)
    EWKZ_0_qcd=OutFile.Get(dirName[0]+"EWKZ2Jets_ZToLL_"+histoname_qcd)
    EWKZ_qcd=OutFile.Get(dirName[0]+"EWKZ2Jets_ZToNuNu_"+histoname_qcd)
    EWKW_0_qcd=OutFile.Get(dirName[0]+"EWKWMinus2Jets_"+histoname_qcd)
    EWKW_qcd=OutFile.Get(dirName[0]+"EWKWPlus2Jets_"+histoname_qcd)
    
    TTJ_qcd=OutFile.Get(dirName[0]+"TTTo2L2Nu_"+histoname)
    TTJ_qcd_1=OutFile.Get(dirName[0]+"TTToHadronic_"+histoname)
    TTJ_qcd_2=OutFile.Get(dirName[0]+"TTToSemiLeptonic_"+histoname)
    
    ggH125_qcd=OutFile.Get(dirName[0]+"GluGluHToTauTau_"+histoname_qcd)
    qqH125_qcd=OutFile.Get(dirName[0]+"VBFHToTauTau_"+histoname_qcd)
    ZHToTauTau_qcd=OutFile.Get(dirName[0]+"ZHToTauTau_"+histoname_qcd)
    WpH125_qcd=OutFile.Get(dirName[0]+"WPlusHToTauTau_"+histoname_qcd)
    WmH125_qcd=OutFile.Get(dirName[0]+"WMinusHToTauTau_"+histoname_qcd)
    sT_t_antitop_qcd=OutFile.Get(dirName[0]+"ST_t-channel_antitop_"+histoname_qcd)
    sT_t_top_qcd=OutFile.Get(dirName[0]+"ST_t-channel_top_"+histoname_qcd)
    sT_tW_antitop_qcd=OutFile.Get(dirName[0]+"ST_tW_antitop_"+histoname_qcd)
    sT_tW_top_qcd=OutFile.Get(dirName[0]+"ST_tW_top_"+histoname_qcd)
    WJets_qcd=OutFile.Get(dirName[0]+"WJetsToLNu_"+histoname_qcd)
    WJets_100To200_qcd=OutFile.Get(dirName[0]+"WJetsToLNu_HT100To200_"+histoname_qcd)
    WJets_200To400_qcd=OutFile.Get(dirName[0]+"WJetsToLNu_HT200To400_"+histoname_qcd)
    WJets_400To600_qcd=OutFile.Get(dirName[0]+"WJetsToLNu_HT400To600_"+histoname_qcd)
    WJets_600To800_qcd=OutFile.Get(dirName[0]+"WJetsToLNu_HT600To800_"+histoname_qcd)
    WJets_800To1200_qcd=OutFile.Get(dirName[0]+"WJetsToLNu_HT800To1200_"+histoname_qcd)
    WJets_1200To2500_qcd=OutFile.Get(dirName[0]+"WJetsToLNu_HT1200To2500_"+histoname_qcd)
    WJets_2500ToInf_qcd=OutFile.Get(dirName[0]+"WJetsToLNu_HT2500ToInf_"+histoname_qcd)
    VVV_qcd=OutFile.Get(dirName[0]+"VVV_"+histoname_qcd)
    ZJetsToNuNu_qcd=OutFile.Get(dirName[0]+"ZJetsToNuNu_"+histoname_qcd)
    WWJJ_qcd=OutFile.Get(dirName[0]+"WpWpJJ_EWK_QCD_"+histoname_qcd)
    ...
    QCD.Add(ZTT3_qcd, -1)
    QCD.Add(ZTT4_qcd, -1)
    QCD.Add(EWKZ_0_qcd, -1)
    QCD.Add(EWKZ_qcd, -1)
    QCD.Add(EWKW_0_qcd, -1)
    QCD.Add(EWKW_qcd, -1)
    QCD.Add(TTJ_qcd, -1)
    QCD.Add(TTJ_qcd_1, -1)   
    QCD.Add(TTJ_qcd_2, -1)   
    QCD.Add(ggH125_qcd, -1)
    QCD.Add(qqH125_qcd, -1)
    QCD.Add(ZHToTauTau_qcd, -1)
    QCD.Add(WpH125_qcd, -1)
    QCD.Add(WmH125_qcd, -1)
    QCD.Add(sT_t_antitop_qcd, -1)
    QCD.Add(sT_t_top_qcd, -1)
    QCD.Add(sT_tW_antitop_qcd, -1)
    QCD.Add(sT_tW_top_qcd, -1)
    QCD.Add(WJets_qcd, -1)
    QCD.Add(WJets_100To200_qcd, -1)
    QCD.Add(WJets_200To400_qcd, -1)
    QCD.Add(WJets_400To600_qcd, -1)
    QCD.Add(WJets_600To800_qcd, -1)
    QCD.Add(WJets_800To1200_qcd, -1)
    QCD.Add(WJets_1200To2500_qcd, -1)
    QCD.Add(WJets_2500ToInf_qcd, -1)
    QCD.Add(VVV_qcd, -1)
    QCD.Add(ZJetsToNuNu_qcd, -1)
    QCD.Add(WWJJ_qcd, -1)
    ...
    QCD.SetFillColor(ROOT.TColor.GetColor("#FFC9FF"))
...
#    stack.Add(QCD) 
    ...
    if histoname=='Events_level_':
      ...
      text_file.write("\n")
      text_file.write(" Total bkg = "+str( ZTT.GetBinContent(9)+TTJ.GetBinContent(9)+WJets.GetBinContent(9)+VV.GetBinContent(9)+ggH125.GetBinContent(9)+ZJetsToNuNu.GetBinContent(9) ))
      text_file.write("\n")
      ...
      text_file.write("\n")
      text_file.write("WJets events = "+str(WJets.GetBinContent(11) ))
      text_file.write("\n")
      ...
      text_file.write("\n")
      text_file.write(" Total bkg = "+str( ZTT.GetBinContent(11)+TTJ.GetBinContent(11)+WJets.GetBinContent(11)+VV.GetBinContent(11)+ggH125.GetBinContent(11)+ZJetsToNuNu.GetBinContent(11) ))
      text_file.write("\n")
      ...
      text_file.write("\n")
      text_file.write("DY events = "+str(ZTT.GetBinContent(13) ))
      text_file.write("\n")
      text_file.write("TT events = "+str(TTJ.GetBinContent(13) ))
      text_file.write("\n")
      text_file.write("WJets events = "+str(WJets.GetBinContent(13) ))
      text_file.write("\n")
      text_file.write(" VV events = "+str( VV.GetBinContent(13) ))
      text_file.write("\n")
      text_file.write(" ggH125 events = "+str( ggH125.GetBinContent(13) ))
      text_file.write("\n")
      text_file.write(" ZJetsToNuNu events = "+str( ZJetsToNuNu.GetBinContent(13) ))
      text_file.write("\n")
      text_file.write("\n")
      text_file.write(" Total bkg = "+str( ZTT.GetBinContent(13)+TTJ.GetBinContent(13)+WJets.GetBinContent(13)+VV.GetBinContent(13)+ggH125.GetBinContent(13)+ZJetsToNuNu.GetBinContent(13) ))
      text_file.write("\n")
      text_file.write("Data events = "+str( HistoData.GetBinContent(13)))
      text_file.write("\n")
...
#      text_file.close()
    ...
    if histoname=='Muon_Pt_3' or histoname=='h_dPhi_3' or histoname=='Muon_Pt_4' or histoname=='Muon_Pt_5' or histoname=='Muon_Pt_6' or histoname=='Muon_Pt_7':
      ...
      nbins_ggH125 = ggH125.GetNbinsX()
      nbins_ZJetsToNuNu = ZJetsToNuNu.GetNbinsX()
      nbins_QCD = QCD.GetNbinsX()
      ...
      print "ggH125 events = ", ggH125.Integral(0,nbins_ggH125+1)
      print "ZJetsToNuNu events = ", ZJetsToNuNu.Integral(0,nbins_ZJetsToNuNu+1)
      print "QCD events = ", QCD.Integral(0,nbins_QCD+1)
      ...
      text_file.write("\n")
      text_file.write("ggH125 events = "+str(ggH125.Integral(0,nbins_ggH125+1) ))
      text_file.write("\n")
      text_file.write("ZJetsToNuNu events = "+str(ZJetsToNuNu.Integral(0,nbins_ZJetsToNuNu+1) ))
      text_file.write("\n")
      text_file.write("QCD  events = "+str(QCD .Integral(0,nbins_QCD+1) ))
      text_file.write("\n")
