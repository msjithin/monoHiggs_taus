...
void make_hist(string input_file, string output_file, string histname_string, string sample_name, string name_ ,  Double_t weight_lumi , bool isNLO, double ngen_, double xsec)
{
  ...
  */
  ...
  if(histname == "Events_level_"){
    ...
    TH1F* histo_etau_7 = (TH1F*)((TH1F*)file_input->Get(histname+"7"))->Clone(TString(name+"_"+histname+"7"));
    ...
    TH1F* histo_etau_17 = (TH1F*)((TH1F*)file_input->Get(histname+"17"))->Clone(TString(name+"_"+histname+"17"));
    ...
    histo_etau_17->Scale(net_weight);
    histo_etau_0->Write();
    histo_etau_1->Write();
    histo_etau_2->Write();
    histo_etau_3->Write();
...
int main(int argc, char** argv)
{
  ...
  */
  ...
  else if (sample=="WJetsToLNu_inc") {xs=61526.7; weight=32.9075;}
  else if (sample=="W1JetsToLNu") {xs=11778.3638; weight=7.09;}
  else if (sample=="W2JetsToLNu") {xs=3849.21974; weight=13.967;}
  else if (sample=="W3JetsToLNu") {xs=1166.04787; weight=2.20;}
  else if (sample=="W4JetsToLNu") {xs=593.055246; weight=2.04;}
