...
def add_lumi():
    ...
    lumi.SetTextFont (   42 )
    lumi.AddText("#mu#tau_{h}   2017, 10.38 fb^{-1} (13 TeV)")
    return lumi
...
#      text_file.close()
    ...
    if histoname=='Muon_Pt_7' or histoname=='Muon_Pt_8' or histoname=='Muon_Pt_9':
...
if piAxis == 1:
  ...
  h1.GetXaxis().SetBinLabel(6,"tau &opp. charge");
  ...
  h1.GetXaxis().SetBinLabel(3,"tau & opp. charge");
