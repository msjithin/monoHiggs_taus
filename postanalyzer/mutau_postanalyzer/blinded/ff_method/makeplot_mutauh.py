...
#    stack.Add(TTJ)
    ...
    if histoname=='Events_level_':
      ...
      text_file.write("\n")
      text_file.write(" Total bkg = "+str( ZTT.GetBinContent(10)+TTJ.GetBinContent(10)+WJets.GetBinContent(10)+VV.GetBinContent(10)+ggH125.GetBinContent(10)+ZJetsToNuNu.GetBinContent(10) ))
      text_file.write("\n")
