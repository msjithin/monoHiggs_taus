...
using namespace std;
Double_t Luminosity = 41521.0*0.25;//Lumi for inclusive
...
void make_hist(string input_file, string output_file, string histname_string, string sample_name, string name_ ,  Double_t weight_lumi , bool isNLO, double ngen_, double xsec)
{
  ...
  */
  ...
  if(histname == "Events_level_"){
    ...
    TH1F* histo_etau_8 = (TH1F*)((TH1F*)file_input->Get(histname+"8"))->Clone(TString(name+"_"+histname+"8"));
    TH1F* histo_etau_9 = (TH1F*)((TH1F*)file_input->Get(histname+"9"))->Clone(TString(name+"_"+histname+"9"));
    ...
    histo_etau_8->Scale(net_weight);
    histo_etau_9->Scale(net_weight);
  ...
  */
  //cout<<"this works too line 158"<<endl;
  if(histname == "Events_level_"){
...
int main(int argc, char** argv)
{
  ...
  */
  else if (sample=="ZTTinc"){ xs=LOtoNNLO_DY*4954.0; weight=1.2193;}
  else if (sample=="ZTT1jet"){ xs=LOtoNNLO_DY*1012.5; weight=0.2726;}
  else if (sample=="ZTT2jet"){ xs=LOtoNNLO_DY*332.8; weight=0.3095;}
  else if (sample=="ZTT3jet"){ xs=LOtoNNLO_DY*101.8; weight=0.5702;}
  else if (sample=="ZTT4jet"){ xs=LOtoNNLO_DY*54.8; weight=0.1356;}
...
//  plotnames.push_back(TString(""));
  ...
  plotnames.push_back(TString("muEn"));
  ...
  xaxis_titles.push_back(TString("#Delta#phi(muon, tau)"));
  plotnames.push_back(TString("dPhiMuTau"));
  ...
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("total M_{T} [GeV]"));
  plotnames.push_back(TString("totalTransverseMass"));
...
*/
  ...
  */
  ...
  //cout<<"This works too! line 579" <<endl;
  ...
  TDirectory *TotalTrMass_ = f_output->mkdir("TotalTrMass_"); 
  ...
  f_output->Close();
   ...
   //cout<<"This workks too! line 624" <<endl;
   ...
   //cout<<"This workks too! line 629" <<endl;
