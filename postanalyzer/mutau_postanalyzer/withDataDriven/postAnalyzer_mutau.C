...
void make_hist(string input_file, string output_file, string histname_string, string sample_name, string name_ ,  Double_t weight_lumi , bool isNLO, double ngen_, double xsec)
{
  ...
  */
  ...
  if(histname == "Events_level_"){
    ...
    TH1F* histo_etau_10 = (TH1F*)((TH1F*)file_input->Get(histname+"10"))->Clone(TString(name+"_"+histname+"10"));
    TH1F* histo_etau_11 = (TH1F*)((TH1F*)file_input->Get(histname+"11"))->Clone(TString(name+"_"+histname+"11"));
    TH1F* histo_etau_12 = (TH1F*)((TH1F*)file_input->Get(histname+"12"))->Clone(TString(name+"_"+histname+"12"));
    TH1F* histo_etau_13 = (TH1F*)((TH1F*)file_input->Get(histname+"13"))->Clone(TString(name+"_"+histname+"13"));
    TH1F* histo_etau_14 = (TH1F*)((TH1F*)file_input->Get(histname+"14"))->Clone(TString(name+"_"+histname+"14"));
    TH1F* histo_etau_15 = (TH1F*)((TH1F*)file_input->Get(histname+"15"))->Clone(TString(name+"_"+histname+"15"));
    TH1F* histo_etau_16 = (TH1F*)((TH1F*)file_input->Get(histname+"16"))->Clone(TString(name+"_"+histname+"16"));
    ...
    histo_etau_10->Scale(net_weight);
    histo_etau_11->Scale(net_weight);
    histo_etau_12->Scale(net_weight);
    histo_etau_13->Scale(net_weight);
    histo_etau_14->Scale(net_weight);
    histo_etau_15->Scale(net_weight);
    histo_etau_16->Scale(net_weight);



    if(sample=="WJetsToLNu"){
      histo_etau_0->Scale(1.213* 124009.94558 /histo_etau_0->Integral());
      histo_etau_1->Scale(1.213* 124009.94558 /histo_etau_1->Integral());
      histo_etau_2->Scale(1.213* 123679.145775 /histo_etau_2->Integral());
      histo_etau_3->Scale(1.213* 120702.219505 /histo_etau_3->Integral());
      
    }
    if( sample=="WJetsToLNu_HT100To200" ){
      histo_etau_0->Scale(1.213* 25317.2812707 /histo_etau_0->Integral());
      histo_etau_1->Scale(1.213* 25317.2812707 /histo_etau_1->Integral());
      histo_etau_2->Scale(1.213* 25193.0824182 /histo_etau_2->Integral());
      histo_etau_3->Scale(1.213* 23723.0493028 /histo_etau_3->Integral());
    }
    if(sample=="WJetsToLNu_HT1200To2500"){
      histo_etau_0->Scale(1.213* 6.74560378399 /histo_etau_0->Integral());
      histo_etau_1->Scale(1.213* 6.74560378399 /histo_etau_1->Integral());
      histo_etau_2->Scale(1.213* 6.68284769263 /histo_etau_2->Integral());
      histo_etau_3->Scale(1.213* 5.36157909688 /histo_etau_3->Integral());
    }
    if( sample=="WJetsToLNu_HT200To400" ){
      histo_etau_0->Scale(1.213* 3991.66892052 /histo_etau_0->Integral());
      histo_etau_1->Scale(1.213* 3991.66892052 /histo_etau_1->Integral());
      histo_etau_2->Scale(1.213* 3968.79631615 /histo_etau_2->Integral());
      histo_etau_3->Scale(1.213* 3589.46116447 /histo_etau_3->Integral());
    }
    if( sample=="WJetsToLNu_HT2500ToInf"){
      histo_etau_0->Scale(1.213* 0.140733348128 /histo_etau_0->Integral());
      histo_etau_1->Scale(1.213* 0.140733348128 /histo_etau_1->Integral());
      histo_etau_2->Scale(1.213* 0.139501487759 /histo_etau_2->Integral());
      histo_etau_3->Scale(1.213* 0.105739994593 /histo_etau_3->Integral());
    }
    if( sample=="WJetsToLNu_HT400To600" ){
      histo_etau_0->Scale(1.213* 356.482330322 /histo_etau_0->Integral());
      histo_etau_1->Scale(1.213* 356.482330322/histo_etau_1->Integral());
      histo_etau_2->Scale(1.213* 354.303794861 /histo_etau_2->Integral());
      histo_etau_3->Scale(1.213* 305.673204422 /histo_etau_3->Integral());
    }
    if( sample=="WJetsToLNu_HT600To800"){
      histo_etau_0->Scale(1.213* 96.9016333222 /histo_etau_0->Integral());
      histo_etau_1->Scale(1.213* 96.9016333222 /histo_etau_1->Integral());
      histo_etau_2->Scale(1.213* 96.219387114 /histo_etau_2->Integral());
      histo_etau_3->Scale(1.213* 80.6423654556 /histo_etau_3->Integral());
    }
    if( sample=="WJetsToLNu_HT800To1200"){
      histo_etau_0->Scale(1.213* 35.0326416269 /histo_etau_0->Integral());
      histo_etau_1->Scale(1.213* 35.0326416269 /histo_etau_1->Integral());
      histo_etau_2->Scale(1.213* 34.6868744865 /histo_etau_2->Integral());
      histo_etau_3->Scale(1.213* 28.5264138654 /histo_etau_3->Integral());
    }
